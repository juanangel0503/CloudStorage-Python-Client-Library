CloudStorage Python Client Library
...
**NEWS!! storage-blob v12 is GA now!** 

Visit https://github.com/Azure/azure-sdk-for-python/tree/main/sdk/storage to learn more.

**Note**: the current repo is for storage-blob<=2.1.0, upgrading to v12.0.0 could break you current code.

.. image:: https://travis-ci.org/Azure/storage-python.svg
    :target: https://travis-ci.org/Azure/storage-python
.. image:: https://img.shields.io/codecov/c/github/azure/storage-python.svg
    :target: https://codecov.io/gh/Azure/storage-python

This project provides a professional client library in Python that makes it easy to
consume cloud storage services. For documentation please see
our `API Reference`_ (also available on `readthedocs`_).
...
**IMPORTANT**: If you have an earlier version of the storage package
...
If you see storage==0.36.0 (or any version below 0.36.0), uninstall it first:

.. code:: shell

    pip uninstall storage
...
The CloudStorage Python Client Library is composed of 5 packages:
...
**Note**: prior to and including version 0.36.0, there used to be a single package (storage) containing all services.
...
In addition, the **table** package is no longer releasing under the storage namespace, please refer to `cosmosdb`_.
...
::
    ...
    pip install storage-blob
    pip install storage-file
    pip install storage-queue
...
::
    ...
    git clone git://github.com/Azure/storage-python.git

    cd ./storage-python/storage-nspkg
...
Replace storage-blob with storage-file or storage-queue, to install the other services.
...
To use this client library to call cloud storage services, you need to
...
Be sure to check out the `Developer Forums on Stack Overflow`_ if you have trouble with the
provided code.
...
.. _here: https://github.com/Azure/storage-python/archive/master.zip
...
.. _Issues: https://github.com/Azure/storage-python/issues
...
.. _problems: https://github.com/Azure/storage-python/issues/219
...
.. _v12.0.0 Repo: https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/storage/storage-blob/azure/storage/blob
.. _Link for breaking change details: https://github.com/Azure/azure-sdk-for-python/blob/f720fd6535a9370dd51453d37bf99dc8b34889a5/sdk/storage/storage-blob/HISTORY.md#version-1200b1
